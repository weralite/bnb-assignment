    ...
    return (
      <div className="hidden 1-md:flex flex-col h-full px-7 justify-center">
        <div className="flex flex-row justify-center space-x-2 pr-5">
          <b className="text-xl pr-6 grey whitespace-nowrap overflow-hidden text-ellipsis"> {selectedCountry ? selectedCountry : "Anywhere"}</b>
          <b className="text-xl border-l pl-6 pr-6 border-custom-grey whitespace-nowrap overflow-hidden text-ellipsis">{getSelectedDates()}</b>
          <b className="text-xl border-l pl-6 pr-6 border-custom-grey whitespace-nowrap overflow-hidden text-ellipsis">{selectedGuests ? `${selectedGuests} Guests` : "Guests"}</b>
        </div>
